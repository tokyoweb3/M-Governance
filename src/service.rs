...
use futures::prelude::*;
use m_governance_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	m_governance_runtime::api::dispatch,
	m_governance_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			m_governance_runtime::opaque::Block, m_governance_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (grandpa_block_import, grandpa_link) =
					grandpa::block_import::<_, _, _, m_governance_runtime::RuntimeApi, _, _>(
